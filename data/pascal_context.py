...
class PASCALContext(data.Dataset):
    ...
    def __init__(self,
        ...
        _human_descriptions_dir = os.path.join(root, 'human_descriptions')
        self.saliency_descriptions = []
        _saliency_descriptions_dir = os.path.join(root, 'saliency_descriptions') """
    ...
    def __getitem__(self, index):
        ...
        #_human_description = self._load_human_description(index)
        #_saliency_description = self._load_saliency_description(index)
        ...
        #sample['human_description'] = _human_description
        #sample['saliency_description'] = _saliency_description
        return sample
    ...
    def _load_human_description(self, index):
        _text = np.load(self.human_descriptions[index]).astype(np.float32)
        return _text

    def _load_saliency_description(self, index):
        _text = np.load(self.saliency_descriptions[index]).astype(np.float32)
        return _text """

...
addpath('./seism/src/scripts/')
addpath('./seism/src/misc/')
addpath('./seism/src/tests/')
addpath('./seism/src/gt_wrappers/')
addpath('./seism/src/io/')
addpath('./seism/src/measures/')
addpath('./seism/src/piotr_edges/')
addpath('./seism/src/segbench/')
...
case 'PASCALContext'
gt_set   = 'test_new';
methods(end+1).name = 'NYUD_multi_task_MultiTaskModel_BertLayer3'; methods(end).io_func = @read_one_png; methods(end).legend =     methods(end).name;  methods(end).type = 'contour';
otherwise
...
filename = '/scratch/grp/grv_shi/k21220263/MTFormer/output/NYUD/swim_transformer2/MultiTaskModel_BertLayer3/results/NYUD_test_edge.txt'
display(filename)
